...
<jsp:setProperty property="id" name="dto2" value="id"/> <!-- name에는 useBean의 id 속성이 그대로 들어가야 함 -->
<jsp:setProperty property="pw" name="dto2" value="1111"/>
<jsp:setProperty property="name" name="dto2" value="name"/>
<jsp:setProperty property="phone" name="dto2" value="01011112222"/>
<jsp:setProperty property="email" name="dto2" value="email@mul.com"/>
